...
# !!!!!!!!!!!!!
# 2017/01/24
# This file is to test the ability of colorful_img_bias network on recovering color in black and white anime images.
# Unfortunately training took way too long and I decided to stop the process. Maybe eventually it can color the images
# but I don't have time to wait for that
# This script will probably take more than a week to run...
# !!!!!!!!!!!!!
...
# 2017/01/25
# The following part was to see if the unet can work after adding the bias. I was expecting that it can at least
# learn the skin color but I now want to test the new unet_both... I could continue this one if I have time.
...
# The following script tries to train two networks at once but it's too slow...
#!/usr/bin/env python
# -*- coding: utf-8 -*-
# This file is for running code that has already finished debugging. This way we don't need to change pycharm
# configuration and/or type the command each time.
